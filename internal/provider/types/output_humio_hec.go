...
type OutputHumioHec struct {
	...
	ExtraHTTPHeaders              []OutputHumioHecExtraHTTPHeaders      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []OutputHumioHecResponseRetrySettings `tfsdk:"response_retry_settings"`
