...
type OutputGrafanaCloud2 struct {
	...
	ExtraHTTPHeaders              []OutputGrafanaCloud2ExtraHTTPHeaders      `tfsdk:"extra_http_headers"`
	...
	Labels                        []OutputGrafanaCloudLabels                 `tfsdk:"labels"`
	LokiAuth                      *OutputGrafanaCloud2LokiAuth               `tfsdk:"loki_auth"`
	...
	PqControls                    *OutputGrafanaCloud2PqControls             `tfsdk:"pq_controls"`
	...
	PrometheusAuth                *OutputGrafanaCloud2PrometheusAuth         `tfsdk:"prometheus_auth"`
	...
	ResponseRetrySettings         []OutputGrafanaCloud2ResponseRetrySettings `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                             `tfsdk:"safe_headers"`
	Streamtags                    []types.String                             `tfsdk:"streamtags"`
	SystemFields                  []types.String                             `tfsdk:"system_fields"`
	TimeoutRetrySettings          *OutputGrafanaCloud2TimeoutRetrySettings   `tfsdk:"timeout_retry_settings"`
