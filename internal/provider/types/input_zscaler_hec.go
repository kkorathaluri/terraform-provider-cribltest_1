...
type InputZscalerHec struct {
	...
	AuthTokens                []InputZscalerHecAuthTokens           `tfsdk:"auth_tokens"`
	CaptureHeaders            types.Bool                            `tfsdk:"capture_headers"`
	Connections               []InputZscalerHecConnections          `tfsdk:"connections"`
	...
	Metadata                  []InputZscalerHecMetadata             `tfsdk:"metadata"`
