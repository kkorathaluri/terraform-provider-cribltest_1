...
type OutputCrowdstrikeNextGenSiem struct {
	...
	ExtraHTTPHeaders              []OutputCrowdstrikeNextGenSiemExtraHTTPHeaders      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []OutputCrowdstrikeNextGenSiemResponseRetrySettings `tfsdk:"response_retry_settings"`
