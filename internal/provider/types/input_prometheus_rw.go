...
type InputPrometheusRw struct {
	...
	Connections           []InputPrometheusRwConnections          `tfsdk:"connections"`
	...
	Metadata              []InputPrometheusRwMetadata             `tfsdk:"metadata"`
	OauthHeaders          []InputPrometheusRwOauthHeaders         `tfsdk:"oauth_headers"`
	OauthParams           []InputPrometheusRwOauthParams          `tfsdk:"oauth_params"`
