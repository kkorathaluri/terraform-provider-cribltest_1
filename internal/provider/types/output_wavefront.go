...
type OutputWavefront struct {
	...
	ExtraHTTPHeaders              []OutputWavefrontExtraHTTPHeaders      `tfsdk:"extra_http_headers"`
	...
	ResponseRetrySettings         []OutputWavefrontResponseRetrySettings `tfsdk:"response_retry_settings"`
