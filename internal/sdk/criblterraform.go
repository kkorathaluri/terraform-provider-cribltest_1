...
func New(serverURL string, opts ...SDKOption) *CriblTerraform {
	sdk := &CriblTerraform{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.2",
			GenVersion:        "2.563.1",
			UserAgent:         "speakeasy-sdk/terraform 0.0.2 2.563.1 4.12.0-alpha.1742471106527-a8a53ddb github.com/speakeasy/terraform-provider-cribl-terraform/internal/sdk",
			ServerURL:         serverURL,
			Hooks:             hooks.New(),
		},
	}
