...
// InputMskKafkaSchemaRegistryMinimumTLSVersion - Minimum TLS version to use when connecting
...
// InputMskKafkaSchemaRegistryMaximumTLSVersion - Maximum TLS version to use when connecting
