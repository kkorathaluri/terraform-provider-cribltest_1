...
type InputHTTPRawAuthTokensExtMetadata struct {
	Name string `json:"name"`
	// JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)
	Value string `json:"value"`
}

func (o *InputHTTPRawAuthTokensExtMetadata) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *InputHTTPRawAuthTokensExtMetadata) GetValue() string {
	if o == nil {
		return ""
	}
	return o.Value
...
type InputHTTPRawAuthTokensExt struct {
	...
	Metadata []InputHTTPRawAuthTokensExtMetadata `json:"metadata,omitempty"`
}
...
func (o *InputHTTPRawAuthTokensExt) GetMetadata() []InputHTTPRawAuthTokensExtMetadata {
	if o == nil {
		return nil
	}
	return o.Metadata
