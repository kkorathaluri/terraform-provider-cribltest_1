...
type InputZscalerHecAuthTokensMetadata struct {
	Name string `json:"name"`
	// JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)
	Value string `json:"value"`
}

func (o *InputZscalerHecAuthTokensMetadata) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *InputZscalerHecAuthTokensMetadata) GetValue() string {
	if o == nil {
		return ""
	}
	return o.Value
...
type InputZscalerHecAuthTokens struct {
	...
	Metadata []InputZscalerHecAuthTokensMetadata `json:"metadata,omitempty"`
}
...
func (o *InputZscalerHecAuthTokens) GetMetadata() []InputZscalerHecAuthTokensMetadata {
	if o == nil {
		return nil
	}
	return o.Metadata
